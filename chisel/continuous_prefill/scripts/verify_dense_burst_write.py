...
def verify(root):
    ...
    marker='BURST_WRITE_DENSE_NUMERIC_PASS cases=13 numeric_cases=11 fault_resets=2 checked_fp32=216128 bit_differences=0 real_idma=1 physical_mac=4096 same_dut=1'
