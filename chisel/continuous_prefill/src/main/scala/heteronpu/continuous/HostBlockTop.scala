...
object EmitHostBlock extends App {
  require(args.length==2 && Set("tiny","real").contains(args(1)),"OUT tiny|real")
...
""")
  Files.writeString(out.resolve("SCOPE.json"),s"""{"host_commands":true,"block_launch":false,"hidden":${s.hidden},"ffn":${s.ffn},"retained_matrix":true,"pinned_idma":true,"attention_fusion":"checked QK/SOFTMAX/PV; no DDR scores","official_weights":false,"timing_signoff":false}\n""")
}
