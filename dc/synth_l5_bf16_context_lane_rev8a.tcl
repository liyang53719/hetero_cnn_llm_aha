# L5.2 Revision 8A: map one early-commit four-context lane from source.
...
set_svf $SVF_OUT
analyze -format sverilog [list $GENERATED_SV $LANE_RTL]
elaborate bf16_context_fma_pipeline_lane4_rev8_candidate
current_design bf16_context_fma_pipeline_lane4_rev8_candidate
...
puts $status_fp "PHASE=revision8a_lane"
puts $status_fp "REVISION=8A"
puts $status_fp "EARLY_CONTEXT_BANK_COMMIT=1"
puts $status_fp "COMPLETION_TO_PRE_BYPASS=0"
...
puts "L5_REV8A_LANE_COMPLETED WNS=$worst_slack"
exit
