# Revision 8A: map scheduler + elastic control + context tags jointly.
...
elaborate bf16_context_front_control_rev8_candidate
current_design bf16_context_front_control_rev8_candidate
...
puts $status_fp "PHASE=revision8a_front_control"
...
puts "L5_REV8A_FRONT_CONTROL_COMPLETED WNS=$worst_slack"
exit
