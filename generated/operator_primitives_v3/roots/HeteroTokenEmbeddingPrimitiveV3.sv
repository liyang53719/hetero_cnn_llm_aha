...
module HeteroTokenEmbeddingPrimitiveV3(	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
  input         clock,	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
                reset,	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
  ...
  always @(posedge clock) begin	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
    ...
    if (reset) begin	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
    ...
    else begin	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
    `ifdef FIRRTL_BEFORE_INITIAL	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
      `FIRRTL_BEFORE_INITIAL	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
      automatic logic [31:0] _RANDOM[0:17];	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
      `ifdef INIT_RANDOM_PROLOG_	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
        `INIT_RANDOM_PROLOG_	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
        for (logic [4:0] i = 5'h0; i < 5'h12; i += 5'h1) begin
          _RANDOM[i] = `RANDOM;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
        end	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
        state = _RANDOM[5'h0][1:0];	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:209:30
        pc = _RANDOM[5'h0][2];	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:209:30, :211:27
        launchReg_descriptors_0 = _RANDOM[5'h0][26:3];	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:209:30, :212:30
        launchReg_descriptors_1 = {_RANDOM[5'h0][31:27], _RANDOM[5'h1][18:0]};	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:209:30, :212:30
        launchReg_descriptors_2 = {_RANDOM[5'h1][31:19], _RANDOM[5'h2][10:0]};	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
        launchReg_descriptors_15 = {_RANDOM[5'hB][31:11], _RANDOM[5'hC][2:0]};	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
        launchReg_dimensions_0 = _RANDOM[5'hC][18:3];	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
        launchReg_dimensions_1 = {_RANDOM[5'hC][31:19], _RANDOM[5'hD][2:0]};	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
        launchReg_dimensions_7 = {_RANDOM[5'hF][31:19], _RANDOM[5'h10][2:0]};	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
        launchReg_tag = _RANDOM[5'h10][18:3];	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
        launchReg_mode = _RANDOM[5'h10][26:19];	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
        resultStatus = {_RANDOM[5'h10][31:27], _RANDOM[5'h11][2:0]};	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30, :213:37
        protocolErrorReg = _RANDOM[5'h11][3];	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:213:37, :214:41
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
      `FIRRTL_AFTER_INITIAL	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_launch_ready = io_launch_ready_0;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:231:28
  assign io_microOp_valid = io_microOp_valid_0;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:232:29
  assign io_microOp_bits_kind = 8'h61;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:238:24
  assign io_microOp_bits_flags = 16'h400;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:239:25
  assign io_microOp_bits_phase = io_microOp_bits_phase_0;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:240:25
  assign io_microOp_bits_tag = launchReg_tag;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
  assign io_microOp_bits_mode = launchReg_mode;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
  assign io_microOp_bits_src0 = launchReg_descriptors_0;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
  assign io_microOp_bits_src1 = launchReg_descriptors_1;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
  assign io_microOp_bits_src2 = launchReg_descriptors_15;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
  assign io_microOp_bits_dst = launchReg_descriptors_2;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
  assign io_microOp_bits_m = launchReg_dimensions_0;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
  assign io_microOp_bits_n = launchReg_dimensions_1;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
  assign io_microOp_bits_k = launchReg_dimensions_7;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
  assign io_microOp_bits_index0 = 16'h0;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:250:26
  assign io_microOp_bits_index1 = 16'h0;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:250:26
  assign io_completion_ready = io_completion_ready_0;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:233:32
  assign io_result_valid = &state;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:209:30, :234:28
  assign io_result_bits_tag = launchReg_tag;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:212:30
  assign io_result_bits_status = resultStatus;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:213:37
  assign io_result_bits_completedPhases = {7'h0, resultStatus == 8'h0 | _pc_T};	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:213:37, :240:25, :255:{34,40,54,84}
  assign io_busy = |state;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:209:30, :235:20
  assign io_protocolError = protocolErrorReg;	// src/main/scala/heteronpu/operator/ProgramsText.scala:165:7, src/main/scala/heteronpu/operator/Protocol.scala:214:41
endmodule
