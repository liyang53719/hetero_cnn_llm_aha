...
| Official Gemmini matmul WS 20M-cycle RTL run | PASS, full WS workload | `work/results/gemmini_baseline_minimal_v3/verilator_matmul_ws_20m.log`; `$finish`, 4 ms simulated, 209.89 s walltime |
