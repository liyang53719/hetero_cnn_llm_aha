...
- First real SRAM views: UHDE SP 6144x128 BASE0.8 TT25 Liberty+Verilog generated/audited; LEF blocked by shared ARM `bifrun` SIGSEGV across all local memory compilers, including Ubuntu18 probe.
