...
- L5 q128 SiLU/product WIP: 1146880-lane golden generated, max error `5.320e-5`, product hash `661f4f57...`; attempt3 stopped before lint because MemAvailable9723808 KiB < strict10485760 KiB, OOM0. Same blocker reached three consecutive Goal turns; Goal blocked until recovery, then run `taskset -c 8-25 scripts/run_l5_q128_silu_product.sh` once.
