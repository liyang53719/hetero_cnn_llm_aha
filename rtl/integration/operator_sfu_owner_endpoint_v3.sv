...
module operator_sfu_owner_endpoint_v3(
 ...
 logic active_q,scratch_q,first_q,last_q,final_valid_q;logic[2:0]sel_q,req_sel;logic[3:0]scratch_src0_q,scratch_src1_q,scratch_dst_q;logic[511:0]scratch[0:9],final_data_q,leaf_a,leaf_b,leaf_c;logic leaf_payload_valid;logic[15:0]bad_tag_q;logic[7:0]bad_parent_q,bad_terminal_q;integer si;
