...
module qwen2_rms_stage_top #(parameter integer ADDR_W=15)(
 ...
 logic pstart,pdone,spv,spr,sov,sor,scv,sready,cmdpend,sseen;logic[49151:0]sx,sw,sy;logic[55:0]scd;logic[4:0]flags;
