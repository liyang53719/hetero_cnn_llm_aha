...
// One production BF16-input/FP32-accumulator lane. Valid/ready state remains
// global in bf16_outer_product_array; these enables update only lane-local data.
`timescale 1ns/1ps
module bf16_fma_pipeline_lane (
  input  logic clk_i,
  input  logic rst_ni,
