...
// Test-only alias.  Candidate filelists must exclude the canonical production
// module when this alias is compiled.
`timescale 1ns/1ps
module bf16_outer_product_context_array #(
  ...
  bf16_outer_product_context_array_rev8_candidate #(
