...
`timescale 1ns/1ps
module fp32_dot128_scaled(
  input  logic clk_i,
  input  logic rst_ni,
  input  logic in_valid_i,
  output logic in_ready_o,
  input  logic [4095:0] a_i,
  input  logic [4095:0] b_i,
  ...
  fp32_reduce16 reduce(
    ...
    .data_i(products), .out_valid_o(reduce_out_valid),
    .out_ready_i(reduce_out_ready), .sum_o(partial_sum),
