...
def main() -> int:
    ...
    lib = args.root / "l2sp6144x128wm_tt_typical_0p80v_0p80v_25c.lib"
    verilog = args.root / "l2sp6144x128wm.v"
    gds2 = args.root / "l2sp6144x128wm.gds2"
    ...
    checks = {
        ...
        "verilog_module": "module l2sp6144x128wm " in verilog_text,
        "verilog_address_13": "reg [12:0] a_int;" in verilog_text,
        "verilog_data_128": "reg [127:0] d_int;" in verilog_text,
        "verilog_write_mask_128": "input [127:0] wen;" in verilog_text,
    }
