...
compile(){
  ...
  MIN_AVAILABLE_KIB=10485760 MEMORY_HIGH=8G MEMORY_MAX=10G "$ROOT/scripts/run_memory_capped.sh" \
...
PYTHONPATH="$ROOT/src" MIN_AVAILABLE_KIB=10485760 MEMORY_HIGH=8G MEMORY_MAX=10G \
