...
OUT=${OUT:-$ROOT/work/results/l10_l2_macro_bank_group}
...
MIN_AVAILABLE_KIB=10485760 MEMORY_HIGH=6G MEMORY_MAX=8G \
  ...
  -DARM_DISABLE_EMA_CHECK -s tb_l2_512b_macro_bank_group -o "$OUT/tb" \
...
MIN_AVAILABLE_KIB=10485760 MEMORY_HIGH=24G MEMORY_MAX=30G \
  ...
  "$ROOT/rtl/memory/l2_512b_macro_bank_group.sv" \
  --top-module l2_512b_macro_bank_group >"$OUT/verilator_lint.log" 2>&1
echo L10_L2_MACRO_BANK_GROUP_GATE_PASS
