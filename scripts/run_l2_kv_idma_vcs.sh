...
cd "$VCS_DIR"
taskset -c 8-23 vlogan -sverilog -full64 +define+USE_UPSTREAM_IDMA \
  ...
  >"$OUT/vlogan.log" 2>&1
taskset -c 8-23 vcs -full64 -top tb_idma_flat_wrap -o simv_flat >"$OUT/vcs_flat.log" 2>&1
taskset -c 8-23 ./simv_flat >"$OUT/flat.log" 2>&1
taskset -c 8-23 vcs -full64 -top tb_kv_descriptor_v2_idma_adapter -o simv_kv >"$OUT/vcs_kv.log" 2>&1
taskset -c 8-23 ./simv_kv >"$OUT/kv.log" 2>&1
...
"cpu_affinity":"taskset -c 8-23","simulator":"VCS W-2024.09"}
