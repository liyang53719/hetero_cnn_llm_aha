...
OUT=${OUT:-$ROOT/work/results/l3_descriptor_fabric}
...
MIN_AVAILABLE_KIB=10485760 MEMORY_HIGH=8G MEMORY_MAX=10G \
  ...
  "$ROOT/rtl/fabric/shared_l2_descriptor_port.sv" \
  "$ROOT/rtl/fabric/shared_l2_macro_descriptor_fabric.sv" \
  --top-module shared_l2_macro_descriptor_fabric >"$OUT/verilator_lint.log" 2>&1
echo L3_DESCRIPTOR_MACRO_FABRIC_GATE_PASS target="$TARGET"
