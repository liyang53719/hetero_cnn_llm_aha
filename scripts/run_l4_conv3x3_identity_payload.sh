#!/usr/bin/env bash
set -euo pipefail
ROOT=$(cd "$(dirname "$0")/.."&&pwd);OUT=$ROOT/work/results/l4_conv3x3_identity;mkdir -p "$OUT"
G=$ROOT/work/upstream/chipyard_gemmini/generators/gemmini/software/gemmini-rocc-tests;S=$ROOT/work/upstream/chipyard_gemmini/sims/verilator/simulator-chipyard.harness-GemminiRocketConfig
