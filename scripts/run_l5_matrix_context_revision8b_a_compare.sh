...
OUT=${OUT:-$ROOT/work/results/l5_matrix_context_revision8b_a/rev8a_vs_rev8b_a}
...
SOURCES=(
  ...
  "$ROOT/tb/tb_bf16_context_array_rev8a_vs_rev8b_a.sv"
)
MIN_AVAILABLE_KIB=10485760 MEMORY_HIGH=24G MEMORY_MAX=30G "$R" "$V" \
  ...
  --top-module tb_bf16_context_array_rev8a_vs_rev8b_a \
...
grep -q 'L5_REV8A_VS_REV8B_A_PASS compared=120000' "$OUT/tb.log"
