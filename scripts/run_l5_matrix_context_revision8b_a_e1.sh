...
OUT=${OUT:-$ROOT/work/results/l5_matrix_context_revision8b_a/e1}
...
SOURCES=(
  ...
  "$ROOT/rtl/matrix/candidates/rev8b_a/bf16_outer_product_context_array_rev8b_a_test_alias.sv"
...
echo L5_MATRIX_CONTEXT_REV8B_A_E1_PASS
