...
PYTHONPATH="$ROOT/src" run_capped 600s "$PY" "$ROOT/scripts/generate_silu_lut_vectors.py" --cases 4096 --output "$OUT/vectors.txt">"$OUT/vector_generation.log";"$ROOT/scripts/generate_all_hardfloat_primitives.sh"
