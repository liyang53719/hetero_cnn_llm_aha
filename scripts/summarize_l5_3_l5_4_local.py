...
r={'schema_version':1,'status':'BRIDGE_AND_COMPONENT_GATES_PASS_SINGLE_SIM_OPEN' if all(checks[k] for k in ('controller_e1','controller_dc','attention_trace_bridge','block32_weight_e1','block32_weight_dc','silu_1lane_e1','silu_2lane_e1','silu_1lane_dc','silu_2lane_dc')) else 'FAIL_OR_INCOMPLETE','checks':checks,'L5.3':{'controller_dc':controller_dc,'block32_weight_dc':weight_dc,'q128_tasks':240,'q384_tasks':1872,'q1024_tasks':12672,'q1024_merge_rows':43008,'trace_bridge_status':bridge.get('status'),'full_numeric_status':'OPEN_SINGLE_INTEGRATED_SIM'},'L5.4':{'one_lane':silu1_dc,'two_lane':silu2_dc,'selection':'WAIT_MEASURED_MATRIX_PRODUCER_STALL','selection_rule':'one_lane_if_stall_le_2_percent_else_two_lane'},'evidence_hashes':{'controller_e1':sha(controller_log),'trace_bridge':sha(bridge_path),'block32_weight_e1':sha(weight_log),'silu1_e1':sha(silu1_log),'silu2_e1':sha(silu2_log)}}
