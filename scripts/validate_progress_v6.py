...
assert control['current_state']=='L5_6_REFERENCE_LM_HEAD_PASS_FOUR_LAYER_RTL_OPEN'
...
assert next_action['decision']=='RUN_QWEN2_REDUCED_FOUR_LAYER_RTL_REPLAY'
...
assert final['status']=='L5_6_REFERENCE_LM_HEAD_PASS_FOUR_LAYER_RTL_OPEN'
...
assert subset['status']=='PASS_REFERENCE_AND_LM_HEAD_SAMPLED_RTL_FOUR_LAYER_RTL_OPEN'
...
result={'schema_version':6,'status':'PASS_V6_12_L5_6_REFERENCE_LM_HEAD','branch_policy':'MAIN_ONLY','L5_2':'PASS','L5_3_full_E2':'PASS','L5_4_selection':'PASS_ONE_LANE','L5_5':'PASS_E3_321_869TPS','L5_6':'PASS_CYCLE_E3_AND_LM_HEAD_SAMPLE_FOUR_LAYER_RTL_OPEN','next':'L5.6_REDUCED_FOUR_LAYER_RTL_REPLAY'}
