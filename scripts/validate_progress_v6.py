...
assert control['current_state']=='Q384_SAMPLED_E2_PASS_NEXT_Q1024_REVIEWED_E2'
assert l52['status']=='PASS' and l52['h3']['wns_ns']>=0
assert local['status']=='BRIDGE_COMPONENT_Q128_Q384_E2_PASS_Q1024_OPEN'
...
assert next_action['decision']=='EXTEND_SAME_RTL_HARNESS_TO_Q1024_REVIEWED_E2'
assert next_action['L5.5_review']['review_floor_tps']==315
assert final['status']=='PASS_V6_10_Q128_Q384_E2_Q1024_OPEN'
...
result={'schema_version':6,'status':'PASS_V6_10_LOCAL_BRIDGE','branch_policy':'MAIN_ONLY','L5_2':'PASS','L5_3_controller':'PASS_E1_E4','L5_3_trace_bridge':'PASS_NOT_SINGLE_SIM','L5_3_block32_weight':'PASS_E1_E4','L5_3_full_E2':'PASS_Q128_Q384_Q1024_OPEN','L5_4_candidates':'PASS_E1_E4','L5_4_selection':'OPEN','L5_5':'WAIT_JOIN'}
