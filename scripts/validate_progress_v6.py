...
assert control['current_state']=='L5_5_SFU_CANDIDATES_PASS_ULTRA_LOW_MARGIN_WAIT_E3'
...
assert next_action['decision']=='RUN_REAL_Q1024_INTEGRATED_E3_COUNTER_PATH'
assert next_action['L5.5_review']['review_floor_tps']==315
assert final['status']=='L5_5_SFU_CANDIDATES_PASS_ULTRA_LOW_MARGIN_WAIT_E3'
...
assert candidate['status']=='PASS_CANDIDATES_ULTRA_LOW_MARGIN_WAIT_E3' and candidate['q1024_projection']['nominal_tokens_per_second']>=315 and candidate['q1024_projection']['stress_tokens_per_second']<315
...
result={'schema_version':6,'status':'PASS_V6_10_LOCAL_BRIDGE','branch_policy':'MAIN_ONLY','L5_2':'PASS','L5_3_full_E2':'PASS','L5_4_selection':'PASS_ONE_LANE','L5_5':'WAIT_INTEGRATED_E3_ULTRA_LOW_MARGIN'}
