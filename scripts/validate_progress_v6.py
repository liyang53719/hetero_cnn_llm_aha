...
assert control["current_state"] == "L5_2_HIER_DC_REV6_FROZEN_READY_JOINT_CONTEXT_LANE"
...
assert ledger["accepted_local_evidence"]["L5.2"]["status"] == "E1_PASS_HIER_DC_REV6_READY_JOINT_CONTEXT_LANE"
assert ledger["accepted_local_evidence"]["L5.2"]["full_top_e4"] == "INTERRUPTED_NO_FINAL_TIMING"
assert next_action["state"] == "READY_JOINT_MAP_CONTEXT_LANE"
