...
control=load('config/control_plane.json');policy=load('config/git_workflow_policy.json');ledger=load('reports/execution/MASTER_LEDGER.json');next_action=load('reports/execution/NEXT_ACTION.json');final=load('reports/final_validation.json');local=load('reports/execution/l5_3_l5_4_local_result.json');attempt=load('reports/execution/l5_q128_single_sim_attempt_result.json');q384=load('reports/execution/l5_q384_sampled_e2_result.json');q1024=load('reports/execution/l5_q1024_reviewed_e2_result.json');stress=load('reports/execution/l5_attention_stress_service_result.json');selection=load('reports/execution/l5_silu_lane_selection_result.json');precheck=load('reports/execution/l5_5_measured_precheck_result.json');candidate=load('reports/execution/l5_5_pipelined_sfu_candidate_result.json');balanced=load('reports/execution/l5_5_balanced_8x8_local_result.json');e3=load('reports/execution/l5_5_q1024_e3_result.json');full=load('reports/execution/l5_qwen2_full_model_trace_result.json');bridge=load('reports/execution/l5_attention_trace_bridge_result.json');probability=load('reports/execution/l5_probability_hilo_result.json');v69=load('reports/execution/sandbox_v69_result.json');l52=load('reports/execution/l5_revision8b_b_local_result.json')
assert control['schema_version']==6 and control['plan_version']=='2026-08-31-v6.12'
...
assert control['current_subgate']=='L5.6_NUMERICAL_SUBSET'
assert control['current_state']=='L5_6_CYCLE_E3_PASS_NUMERICAL_OPEN'
...
assert next_action['decision']=='RUN_QWEN2_FOUR_LAYER_AND_LM_HEAD_NUMERICAL'
...
assert final['status']=='L5_6_CYCLE_E3_PASS_NUMERICAL_OPEN'
...
assert full['status']=='PASS_CYCLE_E3_L5_6_NUMERICAL_OPEN' and full['trace']['tokens_per_second']>=300
...
result={'schema_version':6,'status':'PASS_V6_12_L5_6_CYCLE_E3','branch_policy':'MAIN_ONLY','L5_2':'PASS','L5_3_full_E2':'PASS','L5_4_selection':'PASS_ONE_LANE','L5_5':'PASS_E3_321_869TPS','L5_6':'PASS_CYCLE_E3_321_086TPS_NUMERICAL_OPEN','next':'L5.6_NUMERICAL_SUBSET'}
