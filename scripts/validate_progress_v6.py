...
assert control["current_state"] == "L5_2_BLOCKED_DECISION_CONTEXT_PRE_REMAP"
...
assert ledger["accepted_local_evidence"]["L5.2"]["status"] == "BLOCKED_DECISION_CONTEXT_PRE_REMAP"
assert ledger["accepted_local_evidence"]["L5.2"]["full_top_e4"] == "INTERRUPTED_NO_FINAL_TIMING"
assert next_action["state"] == "BLOCKED_DECISION"
