...
assert control['current_state']=='L5_5_PRECHECK_FAIL_REOPEN_ATTENTION_SFU'
...
assert next_action['decision']=='IMPLEMENT_PIPELINED_BLOCK32_TILE_SFU_CANDIDATE'
assert next_action['L5.5_review']['review_floor_tps']==315
assert final['status']=='L5_5_PRECHECK_FAIL_REOPEN_ATTENTION_SFU'
...
result={'schema_version':6,'status':'PASS_V6_10_LOCAL_BRIDGE','branch_policy':'MAIN_ONLY','L5_2':'PASS','L5_3_full_E2':'PASS','L5_4_selection':'PASS_ONE_LANE','L5_5':'FAIL_REOPEN_ATTENTION_SFU'}
