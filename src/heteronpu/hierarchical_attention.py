...
def exp2_pwl_rtl(x):
    ...
    if x>=0.0:return 1.0
    idx=math.floor(x*16.0)+256;x0=f32(-16.0+idx/16.0);x1=f32(x0+f32(1/16));y0=f32(2.0**x0);y1=f32(2.0**x1);m=f32(f32(y1-y0)/f32(1/16));b=f32(y0-f32(m*x0));return f32(f32(m*x)+b)
