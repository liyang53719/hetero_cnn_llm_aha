...
module tb_qwen2_root_owner_canary_v3;
 ...
 operator_root_bridge_owner_shell_v3 dut(.clk_i,.rst_ni,.microop_valid_i(micro_valid),.microop_ready_o(micro_ready),.microop_kind_i(mk),.microop_flags_i(mflags),.microop_phase_i(mphase),.microop_tag_i(mtag),.microop_mode_i(mmode),.microop_src0_i(ms0),.microop_src1_i(ms1),.microop_src2_i(ms2),.microop_dst_i(mdst),.microop_m_i(mm),.microop_n_i(mn),.microop_k_i(mkdim),.microop_index0_i(mi0),.microop_index1_i(mi1),.root_completion_valid_o(bridge_cv),.root_completion_ready_i(bridge_cr),.root_completion_tag_o(bridge_tag),.root_completion_phase_o(bridge_phase),.root_completion_status_o(bridge_status),.root_completion_predicate_o(bridge_predicate),
  ...
  .matrix_step_valid_i(matrix_step_valid),.matrix_step_ready_o(matrix_step_ready),.matrix_step_context_i(0),.matrix_step_clear_i(1),.matrix_step_last_i(1),.matrix_step_a_i(0),.matrix_step_b_i(0),.matrix_out_valid_o(matrix_out_valid),.matrix_out_ready_i(1),.matrix_out_context_o(matrix_out_context),.matrix_out_last_o(matrix_out_last),.matrix_out_acc_o(matrix_acc),.matrix_exception_flags_o(matrix_flags),.matrix_conv_command_valid_o(matrix_conv_cmd_valid),.matrix_conv_command_ready_i(matrix_conv_cmd_ready),.matrix_conv_command_data_o(matrix_conv_cmd),.matrix_conv_event_valid_i(matrix_conv_event_valid),.matrix_conv_event_ready_o(matrix_conv_event_ready),.matrix_conv_event_data_i(matrix_conv_event),
