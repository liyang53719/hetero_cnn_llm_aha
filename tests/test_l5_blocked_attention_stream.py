...
def test_geometry():
 assert Geometry(128).query_key_pairs==20;assert Geometry(384).query_key_pairs==156;assert Geometry(1024).query_key_pairs==1056;assert Geometry(1024).summary_merges==43008
...
def test_report():assert blocked_attention_stream_report()['status']=='PASS'
